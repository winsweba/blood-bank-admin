...
class AllBloodNeeded extends StatefulWidget {
  const AllBloodNeeded({super.key});

  @override
  State<AllBloodNeeded> createState() => _AllBloodNeededState();
}

class _AllBloodNeededState extends State<AllBloodNeeded> {
